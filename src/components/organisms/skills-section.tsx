...
const SkillsSection = () => {
  const skillCategories = [
    ...
    {
      title: "Backend",
      skills: ["NodeJS", "NestJS", "Python", "Flask", "PostgreSQL", "MongoDB", "REST API", "Prisma"],
    },
    {
      title: "DevOps & Tools",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl sm:text-5xl font-bold text-white mb-4">
            Minhas <span className="text-green-400">Skills</span>
          </h2>
        ...
        <div className="text-center">
          <h3 className="text-2xl font-semibold text-white mb-8">Outras Tecnologias</h3>
